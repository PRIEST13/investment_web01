    ...
    if ($password !== $confirm_password) {
        ...
        if (mysqli_query($conn, $query)) {
            $message = "<div class='alert alert-success m-auto mb-3' style='width:100%;'>
                          <strong>Success!</strong> Registration successful. Please <a href='sign-in.php'>login</a>.
                        </div>";
        } else {
...
<div class="wrapper">
  ...
  <form action="" method="POST">
    ...
    <button type="submit" class="btn btn-warning" name="register_user">Signup</button>
